...
image_array.each do |name|
  Piece.create!(image_url: name, artist_id: 5, art_owner_id: 5, title: name, genre: "modern",
   original_value: 100000, number_prints: 0, art_description: "Very pretty painting", print_value: 800)
end
